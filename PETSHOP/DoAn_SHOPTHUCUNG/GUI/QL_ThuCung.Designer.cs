...
namespace GUI {
    ...
    public partial class QL_ThuCung : global::System.Data.DataSet {
        ...
        public partial class DataTable2DataTable : global::System.Data.TypedTableBase<DataTable2Row> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public DataTable2Row AddDataTable2Row(string TenSP, System.DateTime NGAYHD, decimal DONGIANHAP, decimal DONGIABAN, int SoLuong, decimal DOANHTHU) {
        ...
        public partial class DataTable2Row : global::System.Data.DataRow {
            ...
            public decimal DONGIANHAP {
                get {
                    try {
                        return ((decimal)(this[this.tableDataTable2.DONGIANHAPColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            public decimal DONGIABAN {
                get {
                    try {
                        return ((decimal)(this[this.tableDataTable2.DONGIABANColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            public decimal DOANHTHU {
                get {
                    try {
                        return ((decimal)(this[this.tableDataTable2.DOANHTHUColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'DOANHTHU\' in table \'DataTable2\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableDataTable2.DOANHTHUColumn] = value;
                }
            }
            ...
            public bool IsDOANHTHUNull() {
                return this.IsNull(this.tableDataTable2.DOANHTHUColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public void SetDOANHTHUNull() {
                this[this.tableDataTable2.DOANHTHUColumn] = global::System.Convert.DBNull;
            }
        }
...
FROM     CTHOADON INNER JOIN
    ...
    public partial class DataTable2TableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT SANPHAM.TenSP, HOADON.NGAYHD, CTNHAPHANG.DONGIA AS DONGIANHAP, CTHOADON.DONGIA AS DONGIABAN, SUM(CTHOADON.SOLUONG) AS SoLuong, 
...
GROUP BY SANPHAM.TenSP, HOADON.NGAYHD, CTNHAPHANG.DONGIA, CTHOADON.DONGIA";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
